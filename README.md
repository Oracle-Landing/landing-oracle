...
| 🔄 | jizo | [jizo.buildwithoracle.com](https://jizo.buildwithoracle.com) | `983067e` | `2c67c0d` | yimtheppariyapol/jizo-landing@main |
...
- **jizo** — yimtheppariyapol/jizo-landing@main moved to `2c67c0d`: post: MQTT channel homework — hand-rolled 3.1.1 on a bare socket, proven against mosquitto_pub
